...
#define STRING_CONFIG_H_AUTHOR "(Jonasv01, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycubic i3 Mega Pro"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
//#define MACHINE_UUID "95466956-eb1b-4e77-85bb-b915bbb51670"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define DEFAULT_bedKp 57.98
    #define DEFAULT_bedKi 10.89
    #define DEFAULT_bedKd 205.83
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 2, -10, -3.5 }
